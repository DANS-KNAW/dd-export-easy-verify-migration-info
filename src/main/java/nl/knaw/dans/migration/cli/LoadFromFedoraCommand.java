...
public class LoadFromFedoraCommand extends DefaultConfigEnvironmentCommand<DdExportEasyVerifyMigrationInfoConfiguration> {

    private static final Logger log = LoggerFactory.getLogger(LoadFromFedoraCommand.class);
    private final HibernateBundle<DdExportEasyVerifyMigrationInfoConfiguration> easyBundle;
    ...
    public LoadFromFedoraCommand(
        Application<DdExportEasyVerifyMigrationInfoConfiguration> application,
        HibernateBundle<DdExportEasyVerifyMigrationInfoConfiguration> easyBundle,
        HibernateBundle<DdExportEasyVerifyMigrationInfoConfiguration> expectedBundle
    ) {
    ...
    @Override
    protected void run(Bootstrap<DdExportEasyVerifyMigrationInfoConfiguration> bootstrap, Namespace namespace, DdExportEasyVerifyMigrationInfoConfiguration configuration) throws Exception {
    ...
    public void initialize(Bootstrap<DdExportEasyVerifyMigrationInfoConfiguration> bootstrap, Namespace namespace, DdExportEasyVerifyMigrationInfoConfiguration configuration) throws Exception {
    ...
    @Override
    protected void run(Environment environment, Namespace namespace, DdExportEasyVerifyMigrationInfoConfiguration configuration) throws Exception {
